...
<body>
    <?php
        ...
        //create query
        $query = "SELECT * FROM office ORDER BY name LIMIT $first_page_number,$result_per_page";
                ...
                <div class="container-fluid">
                    ...
                    <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card-header ">
                                    ...
                                    <p class="card-category">Here is the lis of office</p>
                                </div>
                    ...
                    <?php 
                                for($page=1; $page <= $number_of_page; $page++){
                                    echo '<a href="office.php?page='.$page.'" style="margin: right 3px">'. $page. ' </a>';
                                }
                            ?>
                </div>
            </div>
