...
<?php
       ...
       //get the value sent
        ...
        if(isset($_POST['submit'])){
            ...
            header("Location: http://localhost/myrecordapp/save.php");
                                            ...
                                            <div class="col-md-4 pl-1">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="office">
                                                        ...
                                                        <?php while($employee_row = mysqli_fetch_assoc($employee)):?>
                                                            <?php if($employee_row['id'] == $office_id):?>
                                                                <option value="<?php echo $employee_row['id']; ?>" selected>
                                                                    <?php echo $employee_row['name']; ?>
                                                                </option>  
                                                            <?php else:?>
